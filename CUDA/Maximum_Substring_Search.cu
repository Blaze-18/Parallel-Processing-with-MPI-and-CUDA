...
/*
    The Question: Return the longest matching result given any input string from the phonebook1.txt file

    To run this 
    Compile: !nvcc -arch=sm_75 search_phonebook.cu -o search_phonebook
    Run format: !time ./search_phonebook <search_term> <threads_per_block>
    Example Run: 
    !time ./search_phonebook "ANTU_RANI" 100
    !time ./search_phonebook "JAHAN" 256
    !time ./search_phonebook "AKTER" 512
