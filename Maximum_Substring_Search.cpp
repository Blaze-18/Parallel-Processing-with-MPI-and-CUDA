/*
    Question: Return the longest matchging substring from phone book given an input string

    To run this 
    1. Ensure you are in the same directory
    2. Compile: mpic++ Max_Substring.cpp -o out
    3. Run: mpirun -n <num of processes> ./out <phonebook_file.txt> <search_string>
    Example Run:
     mpirun -n 5 ./out phonebook1.txt PANGAMA
      mpirun -n 4 ./out phonebook1.txt PANGAMA
